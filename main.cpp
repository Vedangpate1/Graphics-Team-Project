/*
	Team Number: 5
	Team Members:	Amit Bharucha(MnC)( 2003304 )
					Kartik Disawal(CSE)( 2003119 )
					Vedang Patel(CSE)( 2003125)
*/
#include<stdio.h>
#include<stdlib.h>
#include<GL/glut.h>
...
int winner(char a)
{
	...
	strcpy_s(quote[0], "Better Luck Next Time");
	numberOfQuotes = 5;
...
void house() {
	for (float z = -40; z < 400; z += 4.8)
	{
		...
		float matShine[] = { 150.0 };
		float matAmbAndDif[] = { 0.0, 0.1, 1.0, 1.0 };

		// Light property vectors.
		float lightAmb[] = { 0.0, 0.5, 1.0, 1.0 };
		float lightDifAndSpec[] = { 0.0, 0.5, 1.0, 1.0 };
		float lightPos[] = { 0.0, 3.0, 1.0, 0.0 };
